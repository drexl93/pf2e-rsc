...
<div><input type="radio" id="yes" name="critfail" value="yes" checked><label for="yes">Yes</label>
<input type="radio" id="no" name="critfail" value="no" ><label for="no">No</label>
</div></div>`;
